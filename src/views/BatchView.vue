...
const gridOptions = reactive<VxeGridProps<any>>({
  ...
  columns: [
    ...
    { type: 'radio', title: 'ID', width: 100, fixed: 'left' ,field:'data_id'},
    ...
    { field: 'PH_flag', title: 'PH控制开启/停止标志位', minWidth: 160 },
    { field: 'Ph_auto_handle', title: 'PH控制自动/手动控制标志位', minWidth: 160 },
    ...
    { field: 'cool_water_autoflag', title: '冷凝水通断控制自动/手动标志位', minWidth: 160 },
    ...
    { field: 'motor_speed_autoflag', title: '转速关联氧含量开启/关闭标志位', minWidth: 160 },
    ...
    { field: 'feed_DO_motor_connect_flag', title: '补料双关联转速、氧含量标志位', minWidth: 160 },
