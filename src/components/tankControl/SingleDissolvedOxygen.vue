...
<!--                                                        </ul>-->
<!--                                                    </details>-->
                                                  <select class="dropdown m-1 btn w-[7rem]" @change="controlSend('DO_flag', i, $event.target.value)">
                                                    ...
                                                    <option value="1" :selected="body[col.props]==1" class="text-[#256637] bg-[#BAE7C7] hover:bg-[#A9CDB3] mt-2 rounded">开启</option>
                                                  </select>
