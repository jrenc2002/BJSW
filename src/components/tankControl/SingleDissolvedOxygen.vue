                                                            ...
                                                            <div class="flex justify-center items-center">
                                                                <tr class=" justify-center items-center">
                                                                    ...
                                                                    <td class=" text-center  border-b border-r  hover:bg-[#FAFAFA] cursor-pointer flex justify-center items-center">
                                                                        {{DeviceManage.deviceList[AppGlobal.pageChance]?.nowData?.timing_DO!==undefined&&DeviceManage.deviceList[AppGlobal.pageChance]?.nowData?.timing_DO!==0?DeviceManage.deviceList[AppGlobal.pageChance]?.nowData?.timing_DO+' %':'--'}}
                                                                    </td>
