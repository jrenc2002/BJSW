<template>
    <!-- 主容器，垂直布局 -->
    <div class="flex  flex-col   relative  px-4 top-0] ">
        ...
        <nav class="flex flex-col ">
            ...
            <ul class="flex flex-col gap-y-1 " role="list">
                <div class="w-full min-h-[20rem] ">
                    ...
                    <li class="h-[4rem] flex items-center ">
                        <div class="flex w-[100%]   justify-start items-center inline-flex relative ">
                            <div class="flex justify-start items-center absolute left-[2%]">
                                ...
                                <div class="self-center">
                                    ...
                                    <!-- 用户角色 -->
                                    <div class=" antialiased mt-1 font-bold text-zinc-500 text-base font-normal leading-1 font-iwz">
                                        管理员
                                    </div>
                                </div>
                            </div>
                ...
                <li>
                    ...
                    <!-- 页面列表部分 -->
                    <div class="w-full h-[38vh]   overflow-auto">
                        <ul class="-mx-0 mt-2 space-y-1" role="list">
                            <!-- 遍历页面列表 -->
            ...
            'group flex gap-x-3  rounded-xl p-3 text-sm leading-6 font-semibold']"
                                ...
                                >
                                    <!-- 页面ID -->
                                    <button :class="[team.state===0?'bg-gray-300':'',team.state===1?'bg-white':'',team.state===2?'bg-[#BAE7C7]':'',team.state===3?'bg-[#FAB7B7]':'',
